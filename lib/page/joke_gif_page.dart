...
class _JokeGifPageState extends State<JokeGifPage> {
  ...
  Future<void> _onRefresh() async {
    var _responce = await http.get(APIConstant.BASE_URL +
        ...
        "?type=${APIConstant.TYPE_GIF}&count=${APIConstant.DEFAULT_COUNT}&page=${_page = 1}");
  ...
  _loadMore(var isRefresh) async {
    var _url = APIConstant.BASE_URL +
        APIConstant.ACTION_GET_JOKE +
        "?type=${APIConstant.TYPE_GIF}&count=${APIConstant.DEFAULT_COUNT}&page=${isRefresh ? _page = 1 : ++_page}";
